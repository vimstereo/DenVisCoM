...
class DenVisCor(nn.Module):
    def __init__(self,
        ...
        # Transformer
        self.transformer = FeatureTransformer(attn,
                                              interweaving,
                                              depth,
                                              heads,
    ...
    def extract_feature(self, img0, img1):
        ...
        concat2 = torch.cat((img1, img0), dim=0)  # [2B, C, H, W]
    ...
    def forward(self, img0, img1,
        ...
        if task != 'depth':
            #print(type(attn_splits_list),type(corr_radius_list),type(prop_radius_list))
        ...
        for scale_idx in range(self.num_scales):
            ...
            #print(f'before feature add pos{feature0.shape}')
            ...
            # input()
            # Transformer
            #print(f'og size{feature0.shape}')
