...
class FlyingThings3D(StereoDataset):
    def __init__(self,
                    data_dir='datasets/flying-things-3d',
                 mode='TRAIN',
...
def build_dataset(args):
    if args.stage == 'sceneflow':
        ...
        train_dataset = SintelStereo(transform=train_transform)
        return train_dataset
